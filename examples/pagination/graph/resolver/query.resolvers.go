...
func (r *mutationResolver) UpdateAuthor(ctx context.Context, request storage.UpdateAuthorParams) (storage.Author, error) {
...
func (r *queryResolver) ListAuthors(ctx context.Context, request storage.ListAuthorsParams) (storage.AuthorPage, error) {
